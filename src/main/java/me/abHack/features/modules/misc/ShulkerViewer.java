...
extends Module {
    ...
    public ShulkerViewer() {
        super("ShulkerViewer", "Several tweaks for ShulkerViewer.", Module.Category.MISC, true, false, false);
        this.setInstance();
    }
    ...
    public static void displayInv(ItemStack stack, String name) {
        try {
            ...
            entityBox.setWorld((World)ShulkerViewer.mc.world);
            ...
            new Thread(() -> {
                ...
                ShulkerViewer.mc.player.displayGUIChest((IInventory)entityBox);
            }).start();
        }
    ...
    public void onUpdate() {
        ...
        for (EntityPlayer player : ShulkerViewer.mc.world.playerEntities) {
            if (player == null || !(player.getHeldItemMainhand().getItem() instanceof ItemShulkerBox) || ShulkerViewer.mc.player == player) continue;

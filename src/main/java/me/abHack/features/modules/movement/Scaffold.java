...
extends Module {
    ...
    private final Setting<Boolean> swing = this.register(new Setting<Boolean>("Swing Arm", Boolean.FALSE, v -> this.mode.getValue() == Mode.Legit));
    private final Setting<Boolean> bSwitch = this.register(new Setting<Boolean>("Switch", Boolean.TRUE, v -> this.mode.getValue() == Mode.Legit));
    private final Setting<Boolean> center = this.register(new Setting<Boolean>("Center", Boolean.FALSE, v -> this.mode.getValue() == Mode.Legit));
    private final Setting<Boolean> keepY = this.register(new Setting<Boolean>("KeepYLevel", Boolean.FALSE, v -> this.mode.getValue() == Mode.Legit));
    private final Setting<Boolean> sprint = this.register(new Setting<Boolean>("UseSprint", Boolean.TRUE, v -> this.mode.getValue() == Mode.Legit));
    private final Setting<Boolean> replenishBlocks = this.register(new Setting<Boolean>("ReplenishBlocks", Boolean.TRUE, v -> this.mode.getValue() == Mode.Legit));
    private final Setting<Boolean> down = this.register(new Setting<Boolean>("Down", Boolean.FALSE, v -> this.mode.getValue() == Mode.Legit));
    private final Setting<Float> expand = this.register(new Setting<Float>("Expand", Float.valueOf(2.0f), Float.valueOf(1.0f), Float.valueOf(6.0f), v -> this.mode.getValue() == Mode.Legit));
    ...
    public Setting<Boolean> rotation = this.register(new Setting<Boolean>("Rotate", Boolean.FALSE, v -> this.mode.getValue() == Mode.Fast));
    private int lastY;

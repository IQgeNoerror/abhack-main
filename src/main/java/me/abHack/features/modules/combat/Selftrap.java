...
public class Selftrap extends Module
{
    ...
    public Selftrap() {
        ...
        this.disableTime = (Setting<Integer>)this.register(new Setting("DisableTime", 300, 50, 300));
        this.disable = (Setting<Boolean>)this.register(new Setting("AutoDisable", true));
        this.packet = (Setting<Boolean>)this.register(new Setting("PacketPlace", true));

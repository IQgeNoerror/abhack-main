...
extends Module {
    ...
    public Setting<Float> crystalHealth = this.register(new Setting<Float>("CrystalHP", Float.valueOf(13.0f), Float.valueOf(0.1f), Float.valueOf(36.0f), v -> this.crystal.getValue()));
    public Setting<Float> crystalHoleHealth = this.register(new Setting<Float>("CrystalHoleHP", Float.valueOf(3.5f), Float.valueOf(0.1f), Float.valueOf(36.0f), v -> this.crystal.getValue()));
    public Setting<Boolean> bed = this.register(new Setting<Boolean>("Bed", Boolean.valueOf(true), v -> this.crystal.getValue() == false));
    public Setting<Float> bedHealth = this.register(new Setting<Float>("BedHP", Float.valueOf(13.0f), Float.valueOf(0.1f), Float.valueOf(36.0f), v -> this.bed.getValue()));
    public Setting<Float> bedHoleHealth = this.register(new Setting<Float>("BedHoleHP", Float.valueOf(3.5f), Float.valueOf(0.1f), Float.valueOf(36.0f), v -> this.bed.getValue()));
    ...
    public void doSwitch() {
        ...
        } else if (this.currentMode != Mode2.BEDS && this.bed.getValue().booleanValue() && (EntityUtil.isSafe((Entity)Offhand.mc.player) && EntityUtil.getHealth((Entity)Offhand.mc.player, true) > this.bedHoleHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, true) > this.bedHealth.getValue().floatValue())) {
        ...
        if (this.currentMode == Mode2.BEDS && (!EntityUtil.isSafe((Entity)Offhand.mc.player) && EntityUtil.getHealth((Entity)Offhand.mc.player, true) <= this.bedHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, true) <= this.bedHoleHealth.getValue().floatValue())) {
        ...
        if (this.switchedForHealthReason && (EntityUtil.isSafe((Entity)Offhand.mc.player) && EntityUtil.getHealth((Entity)Offhand.mc.player, true) > this.bedHoleHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, true) > this.bedHealth.getValue().floatValue())) {
        ...
        switch (this.currentMode) {
            ...
            case BEDS: {
                if (this.beds <= 0 || this.holdingBed) break;
                this.lastBedSlot = InventoryUtil.findItemInventorySlot(Items.BED, false);
                int lastSlot = this.getLastSlot(currentOffhandItem, this.lastBedSlot);

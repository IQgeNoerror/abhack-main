...
extends Module {
    ...
    public Setting<Boolean> box = this.register(new Setting<Object>("Box", Boolean.TRUE, v -> this.render.getValue()));
    ...
    public void onBlockEvent(BlockEvent event) {
        ...
        if (event.getStage() == 4 && this.tweaks.getValue().booleanValue() && BlockUtil.canBreak(event.pos)) {

...
extends Module {
    ...
    private final Setting<Integer> gapStack = this.register(new Setting<Integer>("GapStack", 20, 1, 64));
    private final Setting<Integer> xpStackAt = this.register(new Setting<Integer>("XPStack", 20, 1, 64));
    private final Setting<Integer> webStack = this.register(new Setting<Integer>("WebStack", 20, 1, 64));

...
import me.abHack.mixin.mixins.accessors.IEntityLivingBase;
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            if (!player.isInvisible()) {
                ...
                output.put((Object)healthSB + " " + (OyVey.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.getName() + " " + (Object)distanceSB + " \u00c2§f0", (int)EntityUtil.mc.player.getDistance((Entity)player));
